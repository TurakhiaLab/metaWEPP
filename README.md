...
```
# Input reads
fq1: "/path/to/{*R1.fq}" # The path to your R1 read (CHANGE THIS TO THE NAME OF THE READ THAT THEY DOWNLOAD)
fq2: "/path/to/{*R2.fq}" # The path to your R2 read (CHANGE THIS TO THE NAME OF THE READ THAT THEY DOWNLOAD)

# Input FASTA and MAT
REF: "{*.fa}" # The name of your FASTA file that you just downloaded (same as above, change to what they would download)
...
All results generated by WEPP can be found in the `WEPP/results/[INSERT TAXID THEY WOULD USE HERE]` directory.
